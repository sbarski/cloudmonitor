...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    wiredep: {
      bower: {
          ...
          exclude: ['<%= yeoman.app %>/bower_components/requirejs']
      },
    },
    yeoman: yeomanConfig,
      ngconstant: {
        ...
        development: {
          options: {
            dest: '<%= yeoman.app %>/app/scripts/config.js'
          },
          constants: {
            ENV: {
              name: 'development',
              apiEndpoint: 'http://afddemoapi/api'
            }
          }
        },
        production: {
          ...
          constants: {
            ENV: {
              name: 'production',
              apiEndpoint: 'https://afddemo-api.azurewebsites.net/api'
            }
          }
        }
    },
    ...
    uglify: {
      ...
      dist: {
        files: {
          "<%= yeoman.dist %>/scripts/app.js": [ ".tmp/**/*.js", "!<%= yeoman.app %>/scripts/vendors/**"]
        }
      }
    }
  });
  ...
  grunt.registerTask("serve", function(target) {
    ...
    return grunt.task.run(["clean:server", "ngconstant:development", "injector", "wiredep", "concurrent:server", "connect:livereload", "open", "watch"]);
  });
  grunt.registerTask("build", ["clean:dist", "ngconstant:production", "injector", "wiredep", "useminPrepare", "concurrent:dist", "copy:dist", "cssmin", "concat", "uglify", "usemin"]);
